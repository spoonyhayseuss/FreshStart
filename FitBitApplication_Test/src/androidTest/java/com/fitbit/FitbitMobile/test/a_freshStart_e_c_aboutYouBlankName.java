...
public class a_freshStart_e_c_aboutYouBlankName extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public a_freshStart_e_c_aboutYouBlankName() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.sleep(500);
        //Click on Empty Text View
        solo.clickOnView(solo.getView("profile_name"));
        solo.sleep(1000);
