...
public class a_freshStart_e_f_aboutYouHeightUnit extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public a_freshStart_e_f_aboutYouHeightUnit() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnText(java.util.regex.Pattern.quote("feet"));
        solo.clickOnText(java.util.regex.Pattern.quote("cm"));
        solo.clickOnText(java.util.regex.Pattern.quote("185.4"));

        solo.clickOnText(java.util.regex.Pattern.quote("cm"));
        solo.clickOnText(java.util.regex.Pattern.quote("feet"));
        solo.clickOnText(java.util.regex.Pattern.quote("6"));
