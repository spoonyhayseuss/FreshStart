...
public class a_freshStart_c_d_flex extends ActivityInstrumentationTestCase2 {
  	private Solo solo;
    ...
    public a_freshStart_c_d_flex() throws ClassNotFoundException {
	...
	public void testRun() {
        ...
        solo.sleep(500);
        //screenshot
        solo.takeScreenshot("c_d_flex_a_launch");
        ...
        solo.sleep(500);
        //screenshot
        solo.takeScreenshot("c_d_flex_a_b_deviceList");
        //Click on Flex Wireless activity + sleep wristband
        ...
        solo.sleep(500);
        //screenshot
        solo.takeScreenshot("c_d_flex_a_c_charge");
        //Click on Set up your Flex
		solo.clickOnView(solo.getView("btn_setup"));
        solo.takeScreenshot("c_d_flex_a_d_tapOnSetUpFlex");
        ...
        solo.sleep(500);
        //screenshot
        solo.takeScreenshot("c_d_flex_a_e_joinScreen");
	}
}
