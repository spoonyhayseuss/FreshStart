...
public class a_freshStart_c_e_one extends ActivityInstrumentationTestCase2 {
  	private Solo solo;
    ...
    public a_freshStart_c_e_one() throws ClassNotFoundException {
	...
	public void testRun() {
        ...
        solo.sleep(500);
        //screenshot
        solo.takeScreenshot("c_e_one_a_launch");
        ...
        solo.sleep(500);
        //screenshot
        solo.takeScreenshot("c_e_one_b_deviceList");
        //Scroll to One Wireless activity + sleep tracker
		android.widget.ListView listView0 = (android.widget.ListView) solo.getView(android.widget.ListView.class, 0);
		solo.scrollListToLine(listView0, 3);
        solo.takeScreenshot("c_e_one_c_scrollToOne");

        //Click on One Wireless activity + sleep tracker
		solo.clickOnText(java.util.regex.Pattern.quote("One"));
        ...
        solo.sleep(500);
        //screenshot
        solo.takeScreenshot("c_e_one_d_one");
        //Click on Set up your One
		solo.clickOnView(solo.getView("btn_setup"));
        solo.takeScreenshot("c_e_one_e_tapOnSetUpOne");
        ...
        solo.sleep(500);
        //screenshot
        solo.takeScreenshot("c_e_one_f_joinScreen");
	}
}
